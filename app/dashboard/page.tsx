...
export default function Dashboard() {
  ...
  const printRows = useMemo(() => teachers.map(t => ({ teacher: t, row: rows[t.id] || { teacher_id: t.id, direct_start_date: null, pre_start_hours: 0, absence_days: 0, notes: null, pre_start_hours: 0, status: 'لم يبدأ' } })), [teachers, rows]);
